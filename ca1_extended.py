...
def addOlympicRecords():
    ...
    append  = open("olympics_database.txt","a") 
    append.write(record )
...
write  = open("olympics_database.txt","w") #! Opening the file
write.write("creating file ") #!writing in the file


read  = open("olympics_database.txt","r") 
print(read.read())

append  = open("olympics_database.txt","a") 
append.write("and using append method to append")
